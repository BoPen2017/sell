...
import com.zero.repository.OrderDetailRepository;
import com.zero.repository.OrderMasterRepository;
...
//            cartDTOList.add(cartDTO);
        ...
        //4.扣库存
        List<CartDTO> cartDTOList = orderDTO.getOrderDetailList().stream().map(e -> new CartDTO(e.getProductId(),e.getProductQuantity())).collect(Collectors.toList());Collectors.toList();
