            ...
            <div class="col-md-12 column">
                <table class="table table-striped">
                    ...
                    <tr>
                        ...
                        <td><a href="/seller/order/detail?orderId=${orderDTO.orderId}" type="button" class="btn btn-sm btn-info">详情</a></td>
                        <td>
                            <#if orderDTO.getOrderStatusEnum().message == "新订单">
                                <a href="/seller/order/cancel?orderId=${orderDTO.orderId}" type="button" class="btn btn-sm btn-danger">取消</a>
                            </#if>
                        </td>
                    </tr>
                    </#list>
